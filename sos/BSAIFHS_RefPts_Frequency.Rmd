...
source(here('2020_files','projection','write_proj.r'))
source(here('2020_files','projection','write_proj_spcat.r')) # manually changed line 24 to not invoke data subdir
source(here('2020_files','projection','setup.r')) ## changed line 19 to turn of FMSY_35 as was done before
source(here('2020_files','projection','get_proj_res.r'))
