...
## Updated from r4ss output from model m04 
 1918.2   #_last_early_yr_nobias_adj_in_MPD 
 2000.5   #_first_yr_fullbias_adj_in_MPD 
 2013.9   #_last_yr_fullbias_adj_in_MPD 
 2025.7   #_first_recent_yr_nobias_adj_in_MPD 
 0.8209   #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models)
...
## Output from
## replist <- SS_output('Run05_updated_biasadj', verbose=FALSE)
## xx <- SS_tune_comps(replist, option = "Francis")
## Factor Fleet New_Var_adj hash Old_Var_adj New_Francis New_MI Francis_mult Francis_lo Francis_hi MI_mult Type Name Note
4 1 0.064086 # 0.06 0.064086 0.151607 1.0681 0.686134 2.247455 2.526783 len Fishery 
4 2 0.300831 # 0.33 0.300831 1.40165 0.911608 0.63148 1.702715 4.247424 len Survey 
5 1 0.118828 # 0.14 0.118828 1 0.848774 0.561892 1.815451 7.142857 age Fishery 
5 2 0.277893 # 0.15 0.277893 1 1.852623 1.070542 4.554123 6.666667 age Survey 
 -9999   1    0  # terminator
