## SIS version of starter file. do not use for other purposes -CCM
...
#
2 # Number of datafiles to produce: 1st is input, 2nd is estimates, 3rd and higher are bootstrap, 0 turns off all *.ss_new output
...
2020 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2018
...
0 # F_std_basis: 0=raw_annual_F; 1=F/Fspr; 2=F/Fmsy; 3=F/Fbtgt; where F means annual_F; values >=11 invoke multiyr with 10's digit
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1600112566
