write_proj<-function(dir="foo",sdir="data/",data_file="Model1_Proj.dat",data=Models[[1]],NSEX=2,NAGE=30,Nfishery=2,fleets=1:2,rec_age=3, max_age=36,FY=1977,rec_FY=1977,rec_LY_decrement=2,
