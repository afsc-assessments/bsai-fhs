...
mod_2020_new_fsh_len_comps <- SS_output(here(year, 'model_runs','01_data_checks','18.2c_2020_ss3v33022w-new_fsh_len_comps'))
...
```{r, include=FALSE, echo = FALSE, warning = FALSE}
mod_2020_new_srv_bio <- SS_output(here(year, 'model_runs','01_data_checks','18.2c_2020_ss3v33022w-new_srv_biomass')) 
...
```{r, include=FALSE, echo = FALSE, warning = FALSE}
mod_2020_new_srv_caal <- SS_output(here(year, 'model_runs','01_data_checks','18.2c_2020_ss3v33022w-new_srv_caal')) 
...
```{r, include=FALSE, echo = FALSE, warning = FALSE}
mod_2020_new_srv_len <- SS_output(here(year, 'model_runs','01_data_checks','18.2c_2020_ss3v33022w-new_srv_len'))
...
```{r, include=FALSE, echo = FALSE, warning = FALSE}
mod_2020_new_srv_age <- SS_output(here(year, 'model_runs','01_data_checks','18.2c_2020_ss3v33022w-new_srv_age-ghost'))
...
```{r, include=T, echo = FALSE, warning = FALSE, fig.cap= "Only trivial differences in this historical data provided to the original assessment (previous tab) vs. those pulled using  the gapindex package (shown here)." }
knitr::include_graphics(here::here(year, 'model_runs','01_data_checks','18.2c_2020_ss3v33022w-new_srv_age-ghost','plots','comp_gstagedat_flt2mkt0_page1.png'))
```
:::
...
-   Update the `last_yr_fullbias_adj_in_MPD` to 2019.8 (will tune later)
-   Update the `first_recent_yr_nobias_adj_in_MPD` to 2020.3 (will tune later)
...
mod02_01 <- SS_output(here(year, 'model_runs','02_bridging','02.01_18.2c_2020_ss3v33022w-catches-srvbio'))
mod02_02 <- SS_output(here(year, 'model_runs','02_bridging','02.02_18.2c_2020_ss3v33022w-catches-srvbio-srvcaal'))
mod02_03 <- SS_output(here(year, 'model_runs','02_bridging','02.03_18.2c_2020_ss3v33022w-catches-srvbio-srvcaal-srvlen'))
mod02_04 <- SS_output(here(year, 'model_runs','02_bridging','02.04_18.2c_2020_ss3v33022wcatches-srvbio-srvcaal-srvlen-fshage'))
# mod02_05 <- SS_output(here(year, 'model_runs','02_bridging','02.05_18.2c_2020_ss3v33022w-catches-srvbio-srvcaal-srvlen-fshage-fshlen'))
mod02_06 <- SS_output(here(year, 'model_runs','02_bridging','02.06_18.2c_2020_ss3v33022w-catches-srvbio-srvcaal-srvlen-fshage-fshlen-srvage'))
...
# mod02_08x <- SS_output(here(year, 'model_runs','02_bridging','02.08_18.2c_2020_ss3v33022w-newdata-biasramp-francis'))
...
mod02_08 <- SS_output(here(year, 'model_runs','02_bridging','02.08_18.2c_2020_ss3v33022w-newdata-biasramp-francis'))
...
## Data bridging (cumulative)

```{r,  include=T, eval = TRUE, echo = TRUE, warning = FALSE, message =FALSE}
