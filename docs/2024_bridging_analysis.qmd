...
```{r,  include=T, eval = TRUE, echo = FALSE, warning = FALSE, message =FALSE}
mod18.2c_2024_nhaul <- SS_output(here::here(year,'mgmt','18.2c_2024-nhauls'), verbose = FALSE)
