...
-   In the `.ctl` file update the `last_yr_fullbias_adj_in_MPD` to 2019.8 (will tune later)
...
#                   print = TRUE,
# plotdir = here::here(year, 'model_runs','02_bridging','02.06_18.2c_2020_ss3v33022w-catches-srvbio-srvcaal-srvlen-fshage-fshlen-srvage') )

# filepaths <- list.files(here::here(year, 'model_runs','02_bridging','02.06_18.2c_2020_ss3v33022w-catches-srvbio-srvcaal-srvlen-fshage-fshlen-srvage') ,   pattern = 'compare', full.names = TRUE)
# 
