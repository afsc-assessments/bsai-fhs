...
```{r, include = FALSE, warning = FALSE, message = FALSE}
# caal <- gapindex_ages %>% ## this also has lengths
...
## option 2 start with $specimen and basically do Carey's approach
 load("~/assessments/bsai-fhs/2024/data/raw/gapindex_production_data.rdata")
