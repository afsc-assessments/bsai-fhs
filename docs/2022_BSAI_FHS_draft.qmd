...
```{r echo = F, fig.cap="Figure 1. Catch to total biomass ratio using total biomass for age 3+ individuals for flathead sole in the Bering Sea and Aleutian Islands. Points include observed (open points) or estimated (open points) catches for years 2020-2024, which are not present in the base model."}
...
knitr::include_graphics('2022-10-18-index_wCVs.png')
```
