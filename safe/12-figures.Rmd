...
```{r fig1, fig.cap = "Catch to total biomass ratio using total biomass for age 3+ individuals for Flathead sole in the Bering Sea and Aleutian Islands. Points include observed (closed points) or estimated (open points) catches for years 2020-2024."}
knitr::include_graphics(here::here('figs','2023-09-27-fig1_catchvsbio.png'))
```
...
knitr::include_graphics(here::here('figs','2023-09-27-index_wCVs.png'))
```
