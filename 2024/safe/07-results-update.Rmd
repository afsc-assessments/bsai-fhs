...
A comparison of key derived quantities from the base model and the most recent full assessment is shown in Figure \@ref(fig:biofreccompare).  Parameter estimates and likelihood functions have remained similar to `r old_model_name`.
