...
-   **Spawning biomass** is the estimated weight of mature females.

-   **Total biomass** is the estimated weight of all FHS ages 3 and greater.
...
A comparison of key derived quantities from the base model and the most recent full assessment is shown in Figure \@ref(fig:biofreccompare). Parameter estimates and likelihood values have remained similar to `r old_model_name`.
