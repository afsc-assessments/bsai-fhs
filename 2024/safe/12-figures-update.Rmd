...
```{r spr, fig.cap="Catch versus spawning biomass, both in tons.", eval = TRUE}
knitr::include_graphics(here::here(mod_path,"plots","catch_vs_spawnbio.png"))
```

```{r spr, fig.cap="Time series of estimated catch divided by estimated total biomass.", eval = TRUE}
