...
```{r fishagecomps, fig.cap="Observed (colored bars) and predicted (black points) fishery age compositions for BSAI FHS.", eval = TRUE}
knitr::include_graphics(here::here(mod_path,"plots", "comp_agefit__agregatted_across_time.png"))
```

```{r fishlengthcomps, fig.cap="Observed (colored bars) and predicted (black points) fishery length (cm) compositions for BSAI FHS.", eval = TRUE}
