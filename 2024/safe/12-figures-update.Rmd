...
```{r fishagecompsResid, fig.cap="Observed (grey polygons) and predicted (colored lines) fishery age compositions for BSAI FHS, aggregated through time.", eval = TRUE}
...
```{r lengthcompsResid, fig.cap="Observed (grey polygons) and predicted (colored lines) fishery age compositions for BSAI FHS, aggregated through time.", eval = TRUE}
