...
| Double-normal selectivity parameters | Treatment for Survey        |
|--------------------------------------|-----------------------------|
...
: Treatment of age-based selectivity parameters for the survey. The fishery uses age-based logistic selectivity.
