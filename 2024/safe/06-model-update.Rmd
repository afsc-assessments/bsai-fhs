...
A total of XX parameters were estimated inside the assessment model, YY of which were annual recruitment deviations. A description of the treatment of all model parameters (fixed and estimated), their maximum likelihood estimates, and uncertainty intervals are provided in Table \@ref(tab:parposteriorst).
