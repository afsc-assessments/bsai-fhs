...
maturity was 9.7 and age at 95% maturity was 12.8 (Figure \@ref(fig:selex)). The ageing error
matrix was taken directly from the Stock Synthesis model used in
assessments prior to 2004 [@Spencer2004]. The same length–weight
relationship used in 2020, of the form $W = aL^b$ was estimated by fitting to survey data from
