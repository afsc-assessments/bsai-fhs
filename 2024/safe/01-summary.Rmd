...
-   replacment of the input sample sizes for survey compositional data with values obtained from the `surveyISS` package version 1.0.0 (previously, the number of hauls or the nominal sample size [number of otoliths] were used for marginal lengths and coniditional age-at-length data, respectively).
