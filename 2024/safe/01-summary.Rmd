...
*Changes in the input data*: This assessment includes updated catch for `r year-1`, assumed catches of `r prettyNum(c1, big.mark = ',')` t for `r year`, `r prettyNum(c2, big.mark = ',')` t for `r year+1` and `r prettyNum(c3, big.mark = ',')` t for `r year+2` (Figure 9-\@ref(fig:data)). New input data otherwise include:
