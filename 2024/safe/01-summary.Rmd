...
-   updates to the input sample sizes for survey compositional data to values obtained from the `surveyISS` package (previously, the number of hauls or the nominal sample size [number of otolihts] were used for marginal lengths and coniditional age-at-length data, respectively).
