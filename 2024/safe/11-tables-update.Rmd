...
flextable::regulartable(timeseries) %>%
  flextable::set_caption("Estimated time series of female spawning biomass, and total biomass,  fully-selected fishing mortality rate, age 0 Recruitment, for BSAI FHS. Values shown are the median and 95% confidence intervals (parentheses).") %>%
