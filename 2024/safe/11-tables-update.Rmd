...
# (Results) Tier 1-3: Time series w/ associated uncertainty confidence bounds of: total biom,  1+, SB/ spawning output, stock depletion, and fishing mortality (include ests for projection yr) **- render from SS3**stimated recruitment time series with the avg of year classes spawned after 1976
