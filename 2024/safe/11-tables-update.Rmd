...
flextable::regulartable(timeseries %>%
  ...
  flextable::set_caption("Estimated time series of female spawning biomass, total biomass,  fully-selected fishing mortality rate, age 0 Recruitment, for BSAI FHS. Values shown are the median and 95% confidence intervals (parentheses); these are not available for total biomass. The average number of recruits from 1977-present is 1.02 million.") %>%
