...
data.frame(Source = c(rep("NMFS Aleutian Islands Groundfish Trawl Survey", 1),
           ...
           Years = c("1983, 1986, 1991-2000 (triennial), 2002-2006 (biennial), 2010-2022 (biennial)",
                     ...
                     "1982, 1985, 1992-1995, 1999-2019, 2021", 
                    "1982-2019, 2021-2023 (except 2020)",
                    "1963-2024",
...
Survey biomass estimates and associated sampling variability (annual CVs) are shown in Table \@ref(tab:survobs). Survey compositional data (survey conditional ages-at-length, and associated input sample sizes) are shown in Tables \@ref(tab:survagecompstF) and \@ref(tab:survagecompstM). 
