...
Survey biomass estimates and associated sampling variability (annual CVs) are shown in Table \@ref(tab:survobs). Survey compositional data (survey conditional ages-at-length, and associated input sample sizes) are shown in Table \@ref(tab:survagecompst). 
