...
Catches as used in the model are shown in Table \@ref(tab:catches); discards are not used in the model. Fishery-dependent compositional data (catch-at-length and catch-at-age, and associated input sample sizes) are shown in Tables \@ref(tab:fishlengthcompstF) through \@ref(tab:fishagecompstM).
