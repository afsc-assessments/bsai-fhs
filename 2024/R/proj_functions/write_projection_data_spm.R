## updated function to take SS3 outputs
## and populate spm-friendly 'projection_data.dat' file
## adapted from write_proj.R function (worked with older proj ADMB model)
## maia.kapur@noaa.gov

write_projection_data_spm <-function(dir="foo",
                     sdir="data/",
                     ...
                     spawn_month=1, Fratios=0.5)
{
  ...
  write_file=paste0(dir,"/",data_file) ## establish .dat file
